...
function MovingPlatform({ position, args, speed = 1, direction = new Vector3(1, 0, 0), platformVelocityRef, ...props}) {
  ...
  useFrame(({ clock }) => {
    ...
    const moveVector = direction.clone().multiplyScalar(Math.sin(elapsedTime * speed) * 2); // The value 5 controls the amplitude of the oscillation
...
const MovingPlatforms = ({ material }) => {
